...
@page { margin: 0; }
	...
	while($row=mysqli_fetch_array($re))
	{
		...
		$days = $row['noofdays'];
									...
									}else if($meal=="Half Breakfas")
									{
										$type_of_meal =$type_of_bed * 3;
									
									}else if($meal=="Full Breakfas")
									{
	...
	?>
		<header>
			<h1>Invoice</h1>
			<address >
				<p>SUN PLANET HOTEL,</p>
				<p>H-82 Riddhi Siddhi Soc, M M Vora Show Room Dabhol Road, Vadodara:390025,Indian.</p>
				<p>(+91) 9712881978</p>
			</address>
		...
		<article>
			...
			<table class="inventory">
				...
				<tbody>
					<tr>
						...
						<td><span data-prefix>RS. </span><span><?php echo $type_of_room * $nroom; ?></span></td>
					</tr>
					<tr>
						...
						<td><span><?php echo $nroom; ?> </span></td>
						<td><span data-prefix>RS. </span><span><?php echo $type_of_bed * $nroom; ?></span></td>
					</tr>
					<tr>
						...
						<td><span><?php echo $nroom; ?></span></td>
						<td><span data-prefix>RS. </span><span><?php echo $type_of_meal * $nroom; ?></span></td>
					</tr>
				</tbody>
			</table>
			...
			<table class="balance">
				<tr>
					...
					<td><span data-prefix>RS. </span><span><?php echo $type_of_meal * $nroom + $type_of_bed * $nroom + $type_of_room * $nroom; ?></span></td>
				</tr>
				<tr>
		...
		<aside>
			...
			<div >
				<p align="center">Email :- Sunplanet.23@gmail.com|| Web :- www.sunplanet.com || Phone :- +91 9712881978 +91 9825345564 </p>
			</div>
		</aside>
	</body>
</html>
